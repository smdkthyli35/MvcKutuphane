...
namespace MvcKutuphane.Models.Entity
{
    ...
    public partial class DbKutuphaneEntities : DbContext
    {
        ...
        public virtual ObjectResult<EnIyiYayınevi_Result> EnIyiYayınevi()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<EnIyiYayınevi_Result>("EnIyiYayınevi");
        }
    }
}
